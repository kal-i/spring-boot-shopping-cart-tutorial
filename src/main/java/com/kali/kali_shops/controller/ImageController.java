...
import com.kali.kali_shops.service.image.IImageService;
...
public class ImageController {
    ...
    @GetMapping("/image/download/id/{imageId}")
    ...
    @PutMapping("/image/update/id/{imageId}")
    ...
    @DeleteMapping("/image/delete/id/{imageId}")
